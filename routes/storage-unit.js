...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('storageUnit');

// This file contains the logic of every route in Forest Admin for the collection storageUnit:
...
router.post('/storageUnit', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/storageUnit/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/storageUnit/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Storage Units
router.get('/storageUnit', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Storage Units
router.get('/storageUnit/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Storage Unit
router.get('/storageUnit/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Storage Units
router.get('/storageUnit.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Storage Units
router.delete('/storageUnit', permissionMiddlewareCreator.delete(), (request, response, next) => {
