...
const { syliusShippingMethod } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusShippingMethod');

// This file contains the logic of every route in Forest Admin for the collection syliusShippingMethod:
...
// Create a Sylius Shipping Method
router.post('/syliusShippingMethod', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Shipping Method
router.put('/syliusShippingMethod/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Shipping Method
router.delete('/syliusShippingMethod/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Shipping Methods
router.get('/syliusShippingMethod', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Shipping Methods
router.get('/syliusShippingMethod/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Shipping Method
router.get('/syliusShippingMethod/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Shipping Methods
router.get('/syliusShippingMethod.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Shipping Methods
router.delete('/syliusShippingMethod', permissionMiddlewareCreator.delete(), (request, response, next) => {
