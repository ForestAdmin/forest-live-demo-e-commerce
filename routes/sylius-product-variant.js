...
const { syliusProductVariant } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusProductVariant');

// This file contains the logic of every route in Forest Admin for the collection syliusProductVariant:
...
// Create a Sylius Product Variant
router.post('/syliusProductVariant', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Product Variant
router.put('/syliusProductVariant/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Product Variant
router.delete('/syliusProductVariant/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Product Variants
router.get('/syliusProductVariant', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Product Variants
router.get('/syliusProductVariant/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Product Variant
router.get('/syliusProductVariant/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Product Variants
router.get('/syliusProductVariant.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Product Variants
router.delete('/syliusProductVariant', permissionMiddlewareCreator.delete(), (request, response, next) => {
