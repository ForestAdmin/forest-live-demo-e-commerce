...
const { syliusShipping } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusShipping');

// This file contains the logic of every route in Forest Admin for the collection syliusShipping:
...
// Create a Sylius Shipping
router.post('/syliusShipping', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Shipping
router.put('/syliusShipping/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Shipping
router.delete('/syliusShipping/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Shippings
router.get('/syliusShipping', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Shippings
router.get('/syliusShipping/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Shipping
router.get('/syliusShipping/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Shippings
router.get('/syliusShipping.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Shippings
router.delete('/syliusShipping', permissionMiddlewareCreator.delete(), (request, response, next) => {
