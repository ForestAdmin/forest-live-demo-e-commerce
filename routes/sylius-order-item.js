...
const { syliusOrderItem } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusOrderItem');

// This file contains the logic of every route in Forest Admin for the collection syliusOrderItem:
...
// Create a Sylius Order Item
router.post('/syliusOrderItem', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Order Item
router.put('/syliusOrderItem/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Order Item
router.delete('/syliusOrderItem/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Order Items
router.get('/syliusOrderItem', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Order Items
router.get('/syliusOrderItem/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Order Item
router.get('/syliusOrderItem/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Order Items
router.get('/syliusOrderItem.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Order Items
router.delete('/syliusOrderItem', permissionMiddlewareCreator.delete(), (request, response, next) => {
