...
const { syliusPayment } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusPayment');

// This file contains the logic of every route in Forest Admin for the collection syliusPayment:
...
// Create a Sylius Payment
router.post('/syliusPayment', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Payment
router.put('/syliusPayment/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Payment
router.delete('/syliusPayment/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Payments
router.get('/syliusPayment', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Payments
router.get('/syliusPayment/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Payment
router.get('/syliusPayment/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Payments
router.get('/syliusPayment.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Payments
router.delete('/syliusPayment', permissionMiddlewareCreator.delete(), (request, response, next) => {
