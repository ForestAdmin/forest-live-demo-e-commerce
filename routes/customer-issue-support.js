...
const { customerIssueSupport } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('customerIssueSupport');

// This file contains the logic of every route in Forest Admin for the collection customerIssueSupport:
...
// Create a Customer Issue Support
router.post('/customerIssueSupport', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Customer Issue Support
router.put('/customerIssueSupport/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Customer Issue Support
router.delete('/customerIssueSupport/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Customer Issue Supports
router.get('/customerIssueSupport', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Customer Issue Supports
router.get('/customerIssueSupport/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Customer Issue Support
router.get('/customerIssueSupport/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Customer Issue Supports
router.get('/customerIssueSupport.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Customer Issue Supports
router.delete('/customerIssueSupport', permissionMiddlewareCreator.delete(), (request, response, next) => {
