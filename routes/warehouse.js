...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('warehouse');

// This file contains the logic of every route in Forest Admin for the collection warehouse:
...
// Create a Warehouse
router.post('/warehouse', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Warehouse
router.put('/warehouse/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Warehouse
router.delete('/warehouse/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/warehouse', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Warehouses
router.get('/warehouse/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Warehouse
router.get('/warehouse/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Warehouses
router.get('/warehouse.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Warehouses
router.delete('/warehouse', permissionMiddlewareCreator.delete(), (request, response, next) => {
