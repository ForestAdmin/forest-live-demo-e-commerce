...
const { syliusPaymentMethod } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusPaymentMethod');

// This file contains the logic of every route in Forest Admin for the collection syliusPaymentMethod:
...
// Create a Sylius Payment Method
router.post('/syliusPaymentMethod', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Payment Method
router.put('/syliusPaymentMethod/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Payment Method
router.delete('/syliusPaymentMethod/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Payment Methods
router.get('/syliusPaymentMethod', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Payment Methods
router.get('/syliusPaymentMethod/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Payment Method
router.get('/syliusPaymentMethod/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Payment Methods
router.get('/syliusPaymentMethod.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Payment Methods
router.delete('/syliusPaymentMethod', permissionMiddlewareCreator.delete(), (request, response, next) => {
