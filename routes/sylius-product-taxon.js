...
const { syliusProductTaxon } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusProductTaxon');

// This file contains the logic of every route in Forest Admin for the collection syliusProductTaxon:
...
// Create a Sylius Product Taxon
router.post('/syliusProductTaxon', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Product Taxon
router.put('/syliusProductTaxon/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Product Taxon
router.delete('/syliusProductTaxon/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Product Taxons
router.get('/syliusProductTaxon', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Product Taxons
router.get('/syliusProductTaxon/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Product Taxon
router.get('/syliusProductTaxon/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Product Taxons
router.get('/syliusProductTaxon.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Product Taxons
router.delete('/syliusProductTaxon', permissionMiddlewareCreator.delete(), (request, response, next) => {
