...
const { syliusAddress } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusAddress');

// This file contains the logic of every route in Forest Admin for the collection syliusAddress:
...
// Create a Sylius Address
router.post('/syliusAddress', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Address
router.put('/syliusAddress/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Address
router.delete('/syliusAddress/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Addresses
router.get('/syliusAddress', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Addresses
router.get('/syliusAddress/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Address
router.get('/syliusAddress/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Addresses
router.get('/syliusAddress.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Addresses
router.delete('/syliusAddress', permissionMiddlewareCreator.delete(), (request, response, next) => {
