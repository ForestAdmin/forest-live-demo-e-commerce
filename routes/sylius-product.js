...
const { syliusProduct } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusProduct');

// This file contains the logic of every route in Forest Admin for the collection syliusProduct:
...
// Create a Sylius Product
router.post('/syliusProduct', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Product
router.put('/syliusProduct/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Product
router.delete('/syliusProduct/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Products
router.get('/syliusProduct', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Products
router.get('/syliusProduct/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Product
router.get('/syliusProduct/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Products
router.get('/syliusProduct.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Products
router.delete('/syliusProduct', permissionMiddlewareCreator.delete(), (request, response, next) => {
