...
const { syliusCustomer } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusCustomer');

// This file contains the logic of every route in Forest Admin for the collection syliusCustomer:
...
// Create a Sylius Customer
router.post('/syliusCustomer', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Customer
router.put('/syliusCustomer/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Customer
router.delete('/syliusCustomer/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Customers
router.get('/syliusCustomer', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Customers
router.get('/syliusCustomer/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Customer
router.get('/syliusCustomer/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Customers
router.get('/syliusCustomer.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Customers
router.delete('/syliusCustomer', permissionMiddlewareCreator.delete(), (request, response, next) => {
