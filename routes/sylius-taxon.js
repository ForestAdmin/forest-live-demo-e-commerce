...
const { syliusTaxon } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('syliusTaxon');

// This file contains the logic of every route in Forest Admin for the collection syliusTaxon:
...
// Create a Sylius Taxon
router.post('/syliusTaxon', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Sylius Taxon
router.put('/syliusTaxon/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Sylius Taxon
router.delete('/syliusTaxon/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Sylius Taxons
router.get('/syliusTaxon', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Sylius Taxons
router.get('/syliusTaxon/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Sylius Taxon
router.get('/syliusTaxon/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Sylius Taxons
router.get('/syliusTaxon.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Sylius Taxons
router.delete('/syliusTaxon', permissionMiddlewareCreator.delete(), (request, response, next) => {
